...
OBJECTS = main.o Evaluator.o Vars.o Variables.o Resources.o FileLoader.o Console.o Program.o Visual.o Input.o Sound.o Graphics.o Panel.o TileMap.o Background.o
